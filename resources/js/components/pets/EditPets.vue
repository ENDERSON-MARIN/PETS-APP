                ...
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-header">
                            Update Pet
                            <router-link :to="{ name: 'indexPets' }" class="float-right">go Home</router-link>
                        </div>
                        ...
                        <div class="card-body">
                            <form @submit.prevent="updatePet">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="photo" name="photo" v-model="form.photoUrl" type="text"
                                            class="form-control " required />
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <select v-model="form.tags" name="tags" class="form-control"
                                            aria-label="Default select example">
                                            <option v-for="tag in labels" :key="tag.id" :value="tag.name">{{ tag.name }}
                                            </option>
                                        </select>
                                    </div>
                                </div>
